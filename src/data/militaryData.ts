...
// v5 — Deep Research v2 (March 11, 2026 night)
// Source: Gemini Deep Research batch b6558ec6 — Wikipedia, GlobalFirepower 2026
const v5Categories: ForceCategory[] = [
  {
    id: "active",
    labelKey: "cat.active",
    data: { usa: 1344500, israel: 169500, iran: 610000 },
    change: { usa: 11470, israel: 0, iran: 0 },
    source: "Wikipedia / GFP 2026 (Deep Research v2)",
    note: { usa: "FY2026 authorized limit" },
  },
  {
    id: "reserve",
    labelKey: "cat.reserve",
    data: { usa: 799500, israel: 465000, iran: 350000 },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Wikipedia (Deep Research v2)",
  },
  {
    id: "aircraft",
    labelKey: "cat.aircraft",
    data: { usa: 2717, israel: 284, iran: 209 },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "GlobalFirepower 2026 (Deep Research v2)",
    note: { usa: "1791 fighters + 926 attack", israel: "239 fighters + 45 attack", iran: "188 fighters + 21 attack, legacy" },
  },
  {
    id: "tanks",
    labelKey: "cat.tanks",
    data: { usa: 5500, israel: 1300, iran: 1996 },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "IISS 2026 (adjusted from GFP armor totals)",
    note: { usa: "GFP: 4,666 Abrams", israel: "GFP: 1,300 Merkava", iran: "GFP: 2,675 legacy+Karrar" },
  },
  {
    id: "naval",
    labelKey: "cat.naval",
    data: { usa: 465, israel: 82, iran: 109 },
    change: { usa: 0, israel: 15, iran: 0 },
    source: "GlobalFirepower 2026 (Deep Research v2)",
    note: { israel: "incl. subs & coastal boats", iran: "25 subs + fast craft" },
  },
  {
    id: "ammunition",
    labelKey: "cat.ammunition",
    data: { usa: "N/A", israel: "N/A", iran: "N/A" },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Classified — Deep Research v2",
    format: "number",
  },
  {
    id: "interceptors",
    ...
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Classified — Deep Research v2",
    note: { israel: "critically depleted in Op. Wrath" },
  },
  {
    id: "air_defense",
    labelKey: "cat.air_defense",
    ...
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Classified — Deep Research v2",
    note: { usa: "50 Patriot + 7 THAAD batteries", israel: "9+ Iron Dome batteries" },
  },
  {
    id: "uav_fleet",
    labelKey: "cat.uav_fleet",
    ...
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Classified — Deep Research v2",
    note: { israel: "Hermes, Heron production", iran: "mass Shahed production" },
  },
  {
    id: "missiles",
    labelKey: "cat.missiles",
    ...
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Classified — Deep Research v2",
    note: { iran: "largest in ME, exact count unknown" },
  },
  {
    id: "tel_launchers",
    labelKey: "cat.tel_launchers",
    data: { usa: "N/A", israel: "N/A", iran: "N/A" },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Operation Wrath data — Deep Research v2",
    note: { iran: "critically attrited from 300+ to <120" },
  },
  {
    id: "budget",
    labelKey: "cat.budget",
    data: { usa: 901000000000, israel: 46500000000, iran: 9230000000 },
    change: { usa: 69500000000, israel: 11900000000, iran: 0 },
    source: "Wikipedia / GFP 2026 (Deep Research v2)",
    format: "currency",
    note: { usa: "est. topline 2026", israel: "8.8% GDP wartime spike" },
  },
  {
    id: "nuclear",
    labelKey: "cat.nuclear",
    data: { usa: 5244, israel: 90, iran: "N/A" },
    change: { usa: 0, israel: 5, iran: 0 },
    source: "Wikipedia (Deep Research v2)",
    note: { israel: "peak historical est.", iran: "no confirmed weapons per NPT" },
  },
  {
    id: "munitions_cost",
    labelKey: "cat.munitions_cost",
  ...
  },
  {
    id: "mil_kia",
    labelKey: "cat.mil_kia",
    data: { usa: "N/A", israel: 1153, iran: "N/A" },
    change: { usa: 0, israel: -19493, iran: 0 },
    source: "Wikipedia (Deep Research v2)",
    note: { israel: "1152 as of Oct 2025 + recent losses", iran: "state secrecy" },
  },
  {
    id: "civ_killed",
    labelKey: "cat.civ_killed",
    data: { usa: "N/A", israel: "N/A", iran: "N/A" },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Deep Research v2",
    note: { israel: "exact civilian split N/A", iran: "state secrecy" },
  },
  {
    id: "civ_killed_other",
    labelKey: "cat.civ_killed_other",
  ...
  },
  {
    ...
    data: { usa: "—", israel: "—", iran: "—" },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Gaza MoH (Deep Research v2)",
  },
  {
    id: "lebanon_killed",
    labelKey: "cat.lebanon_killed",
    data: { usa: "—", israel: "—", iran: "—" },
    change: { usa: 0, israel: 0, iran: 0 },
    source: "Lebanon MoH (Deep Research v2)",
  },
];
